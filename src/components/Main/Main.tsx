...
const Main = () => {
  const {onSent,recentPrompts,showResults,loading,resultData,setInput,input} = useContext(Context)
      ...
      <div className="main-container ">
        ...
        <div className="main-bottom">
            <div className="search-box">
                <input onChange={(e)=>setInput(e.target.value)} value={input} type="text" placeholder="Is there anything I can help you with?"/>
                <div>
